        ...
        et_firstConversion.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                try {
                    ...
                    Toast.makeText(applicationContext, "Input value", Toast.LENGTH_SHORT).show()
                }
            }
    ...
    private fun getApiResult() {
        if (et_firstConversion != null && et_firstConversion.text.isNotEmpty() && et_firstConversion.text.isNotBlank()) {
            ...
            if (baseCurrency == convertedToCurrency) {
                Toast.makeText(
                    applicationContext,
                    "Please make a selection of currency you want to calculate :)",
                    Toast.LENGTH_SHORT
                ).show()
            } else {
